...
class Page extends CI_Controller 
{
	...
	public function index()
	{
		...
		$data['page_photo_gallery'] = $this->Model_page->show_photo_galery();
		$data['page_represented'] = $this->Model_page->show_represented();
		$data['page_icons'] = $this->Model_page->show_icons();
	...
	public function update()
	{
		...
		if(isset($_POST['form_home_client'])) {
        	$form_data = array(
				'home_client_title'    => $_POST['home_client_title'],
				'home_client_subtitle' => $_POST['home_client_subtitle'],
				'home_client_status'   => $_POST['home_client_status']
            );
        	$this->Model_page->update_home($form_data);
        	$success = 'As informações da Seção Cliente da página inicial foram atualizadas com sucesso!';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
		}

		if(isset($_POST['form_home_represented'])) {
        	$form_data = array(
				'home_represented_title'    => $_POST['home_represented_title'],
				'home_represented_subtitle' => $_POST['home_represented_subtitle'],
				'home_represented_status'   => $_POST['home_represented_status']
            );
        	$this->Model_page->update_home($form_data);
        	$success = 'As informações da Seção Representadas da página inicial foram atualizadas com sucesso!';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
		}

		if(isset($_POST['form_home_notice'])) {
        	$form_data = array(
				'home_notice_title'    => $_POST['home_notice_title'],
				'home_notice_message' => $_POST['home_notice_message'],
				'home_notice_status'   => $_POST['home_notice_status']
            );
        	$this->Model_page->update_home($form_data);
        	$success = 'As informações da Seção Noticia da página inicial foram atualizadas com sucesso!';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
		}
		...
		if(isset($_POST['form_contact'])) {
        	$form_data = array(
				...
				'contact_schedule'  => $_POST['contact_schedule'],
		...
		if(isset($_POST['form_photo_galery'])) {
        	$form_data = array(
				'photo_gallery_heading' => $_POST['photo_gallery_heading'],
				'mt_photo_gallery'      => $_POST['mt_photo_gallery'],
				'mk_photo_gallery'      => $_POST['mk_photo_gallery'],
				'md_photo_gallery'      => $_POST['md_photo_gallery']
            );
        	$this->Model_page->update_photo_galery($form_data);
        	$success = 'Photo Galery Page Setting is updated successfully!';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
		}

		if(isset($_POST['form_represented'])) {
        	$form_data = array(
				'represented_heading' => $_POST['represented_heading'],
				'mt_represented'      => $_POST['mt_represented'],
				'mk_represented'      => $_POST['mk_represented'],
				'md_represented'      => $_POST['md_represented']
            );
        	$this->Model_page->update_represented($form_data);
        	$success = 'Photo Galery Page Setting is updated successfully!';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
		}
	...
	public function upload()
	{
		if($this->input->is_ajax_request())
		{
			...
			$name = 'summernote_'.$_FILES['image']['name'];
			$destination = 'public/uploads/img/' . $name;
						
			// updating the data
	    	move_uploaded_file( $_FILES['image']['tmp_name'], './public/uploads/img/' . $name );
