...
//echo '<pre>';
//var_dump($all_menu_home);
//echo $all_menu_home[0]['home_team_status'];
//die();
?>
<?php 
$error_message = '';
...
<head>
    ...
    if($class_name == 'represented')
    {
        echo '<meta name="description" content="'.$page_represented['md_represented'].'">';
        echo '<meta name="keywords" content="'.$page_represented['mk_represented'].'">';
        echo '<title>'.$page_represented['mt_represented'].'</title>';
    }
    ...
    <style>
        ...
        .ribbon .label {
            ...
            -webkit-box-shadow: 0px 0px 6px rgba(75, 153, 67, 1);
            -moz-box-shadow: 0px 0px 6px rgba(75, 153, 67, 1);
            -ms-box-shadow: 0px 0px 6px rgba(75, 153, 67, 1);
            box-shadow: 0px 0px 6px rgba(75, 153, 67, 1);
                ...
                <div class="col-xl-6 col-lg-5 col-12">
                    <div class="header-social">
                        <ul>
                                ...
                                <div class="social-bar">
                                    <ul>
                                        ...
                                        foreach ($social as $row)
                                        {
                                            if($row['social_url']!='')
                                            {
                                                echo '<li><a href="'.$row['social_url'].'" target="_blank"><i class="'.$row['social_icon'].'"></i></a></li>';
                                            }
                                        }
                                        ?>
                            ...
                            <li style="color: #fff; text-align: center; font-family: 'Roboto Condensed', sans-serif; font-weight: 500;">DISTRIBUIDOR EXCLUSIVO EM BRASÍLIA E GOIÁS.</li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="header-info">
                        <ul>
                            <li>
                                ...
                                <span><a class="text-white" href="<?php echo 'mailto:'.$setting['top_bar_email']; ?>"><?php echo $setting['top_bar_email']; ?></a></span>
                            </li>
                            <li>
                ...
                <div class="col-lg-9 col-12 main-menu">
                    <div class="main-menu-item">
                        <ul class="nav-menu">
                            ...
                            <?php 
                            if($all_menu_home[0]['home_team_status'] !== 'Ocultar'):
                            ?>
                            ...
                            <li class="menu-item-has-children"><a href="#"><?php echo PAGE; ?></a>
                                <ul>
                                    <?php 
                                    if($all_menu_home[0]['home_represented_status'] !== 'Ocultar'):
                                    ?>
                                    <li><a href="<?php echo base_url(); ?>represented"><?php echo REPRESENTED; ?></a></li>
                                    <?php
                                    endif;
                                    ?>
                                    <?php 
                                    if($all_menu_home[0]['home_ptable_status'] !== 'Ocultar'):
                                    ?>
