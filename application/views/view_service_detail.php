            ...
            <div class="col-lg-8">
                <div class="service-info">
                    <div class="portfolio-carousel owl-carousel">
                        ...
                        <?php
                        if(!empty($service_photo)) {
                            foreach ($service_photo as $row) {
                                ?>
                                <a href="<?php echo base_url(); ?>public/uploads/service_photos/<?php echo $row['photo']; ?>" class="magnific">
                                    <img src="<?php echo base_url(); ?>public/uploads/service_photos/<?php echo $row['photo']; ?>" alt="Foto Produto">
                                </a>
                                <?php
                            }
                        }
