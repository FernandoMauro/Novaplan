    ...
    <div class="slide-carousel slider-one owl-carousel">
        ...
        foreach ($sliders as $slider) {
            ...
            <div class="slider-item flex" style="background-image:url(<?php echo base_url(); ?>public/uploads/<?php echo $slider['photo']; ?>);">
                ...
                <div class="ribbon">
            		<div class="label">Distribuidor Exclusivo DF/GO</div>
            	</div>
                <div class="container">
                    <div class="row">
                        <div class="<?php if($slider['position'] == 'Left') {echo 'col-lg-6 col-md-9 col-12';} else {echo 'offset-lg-6 col-lg-6 offset-md-3 col-md-9 col-12';} ?>">
                            <div class="slider-text">
                                ...
                                <?php if($slider['content']!=''): ?>
                                    <div class="text-animated text-justify">
                                        <p>
                                    ...
                                    <div class="text-animated">
                                        <ul>                                        
                                            <?php if($slider['button1_text'] != ''): ?>
                                                <li><a href="<?php echo base_url().$slider['button1_url']; ?>"><?php echo $slider['button1_text']; ?></a></li>
                                            <?php endif; ?>

                                            <?php if($slider['button2_text'] != ''): ?>
                                                <li><a href="<?php echo base_url().$slider['button2_url']; ?>"><?php echo $slider['button2_text']; ?></a></li>
                                            <?php endif; ?>
                                        </ul>
                                    </div>
                                <?php endif; ?>
...
<!--Services Start-->
<?php if($page_home['home_service_status'] == 'Mostrar'): ?>
...
<!--About Start-->
<?php if($page_home['home_welcome_status'] == 'Mostrar'): ?>
    <div class="about-area pt_60 pb_90">
        <div class="container">
            <div class="row">
                        ...
                        <div class="progress-gallery main-prog">
                            ...
                            <?php if( $page_home['home_welcome_pbar1_text']!='' && $page_home['home_welcome_pbar1_value']!='' ): ?>
                                <div class="bar-container">
                                    ...
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-success progress-bar-custom" role="progressbar" aria-valuenow="<?php echo $page_home['home_welcome_pbar1_value']; ?>" aria-valuemin="0" aria-valuemax="100" id="bar1">
                                        </div>
                                    </div>
                                    <div class="percentage-Mostrar"><?php echo $page_home['home_welcome_pbar1_value']; ?>%</div>
                                </div>
                            <?php endif; ?>
                            ...
                            <?php if( $page_home['home_welcome_pbar2_text']!='' && $page_home['home_welcome_pbar2_value']!='' ): ?>
                                <div class="bar-container">
                                    ...
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-success progress-bar-custom" role="progressbar" aria-valuenow="<?php echo $page_home['home_welcome_pbar2_value']; ?>" aria-valuemin="0" aria-valuemax="100" id="bar2">
                                        </div>
                                    </div>
                                    <div class="percentage-Mostrar"><?php echo $page_home['home_welcome_pbar2_value']; ?>%</div>
                                </div>
                            <?php endif; ?>
                            ...
                            <?php if( $page_home['home_welcome_pbar3_text']!='' && $page_home['home_welcome_pbar3_value']!='' ): ?>
                                <div class="bar-container">
                                    ...
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-success progress-bar-custom" role="progressbar" aria-valuenow="<?php echo $page_home['home_welcome_pbar3_value']; ?>" aria-valuemin="0" aria-valuemax="100" id="bar3">
                                        </div>
                                    </div>
                                    <div class="percentage-Mostrar"><?php echo $page_home['home_welcome_pbar3_value']; ?>%</div>
                                </div>
                            <?php endif; ?>
                            ...
                            <?php if( $page_home['home_welcome_pbar4_text']!='' && $page_home['home_welcome_pbar4_value']!='' ): ?>
                                <div class="bar-container">
                                    ...
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-success progress-bar-custom" role="progressbar" aria-valuenow="<?php echo $page_home['home_welcome_pbar4_value']; ?>" aria-valuemin="0" aria-valuemax="100" id="bar4">
                                        </div>
                                    </div>
                                    <div class="percentage-Mostrar"><?php echo $page_home['home_welcome_pbar4_value']; ?>%</div>
                                </div>
                            <?php endif; ?>
                            ...
                            <?php if( $page_home['home_welcome_pbar5_text']!='' && $page_home['home_welcome_pbar5_value']!='' ): ?>
                                <div class="bar-container">
                                    ...
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-success progress-bar-custom" role="progressbar" aria-valuenow="<?php echo $page_home['home_welcome_pbar5_value']; ?>" aria-valuemin="0" aria-valuemax="100" id="bar5">
                                        </div>
                                    </div>
                                    <div class="percentage-Mostrar"><?php echo $page_home['home_welcome_pbar5_value']; ?>%</div>
                                </div>
                            <?php endif; ?>
                ...
                <div class="col-lg-6 mt_30">
                    <div class="about-tab" style="background-image: url(<?php echo base_url(); ?>public/uploads/<?php echo $page_home['home_welcome_video_bg']; ?>); opacity: 1; ">
...
<!--Choose-Area Start-->
<?php if($page_home['home_why_choose_status'] == 'Mostrar'): ?>
...
<!--Feature-Area Start-->
<?php if($page_home['home_feature_status'] == 'Mostrar'): ?>
...
<!--Counter-Area Start-->
<?php if($page_home['counter_status'] == 'Mostrar'): ?>
...
<!--Portfolio Start-->
<?php if($page_home['home_portfolio_status'] == 'Mostrar'): ?>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="portfolio-menu">
                        <ul id="filtrnav">
                            <li class="filtr filtr-active" data-filter="all">Tudo</li>
                            <?php
...
<!--Booking-Area Start-->
<?php if($page_home['home_booking_status'] == 'Mostrar'): ?>
                        ...
                        <div class="booking-form pt_30">
                            ...
                            <div class="form-row row">
                                ...
                                <div class="form-group col-6"> 
                                    <input type="text" class="form-control" placeholder="Digite aqui o texto do Captcha:" name="captcha" value="<?php echo set_value('captcha'); ?>" required>
                                </div>
                                <div class="form-group col-4" alt="Captcha" id="captcha"><?= $captcha_image ?></div>                            
                                <div class="form-group col-2" title="Gera novo Captcha" id="refresh_captcha"> 
                                    <i class="fa fa-refresh fa-2x btn"></i>
                                </div>
                                <div class="form-group col-12">
...
<!--Team-Area Start-->
<?php if($page_home['home_team_status'] == 'Mostrar'): ?>
...
<!--Price-Table Start-->
<?php if($page_home['home_ptable_status'] == 'Mostrar'): ?>
...
<?php if($page_home['home_testimonial_status'] == 'Mostrar'): ?>
...
<!--Represented-Area Start-->
<?php if($page_home['home_represented_status'] == 'Mostrar'): ?>
    <div class="brand-area bg-area pt_90 pb_90">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="headline">
                        <h2><?php echo $page_home['home_represented_title']; ?></h2>
                        <h3><?php echo $page_home['home_represented_subtitle']; ?></h3>
                    </div>
                </div>
            </div>
            <div class="row">
...
<?php endif; ?>
<!--Represented-Area End-->


<!--Blog-Area Start-->
<?php if($page_home['home_blog_status'] == 'Mostrar'): ?>
                ...
                <div class="col-12">
                    <div class="blog-carousel owl-carousel">                    
                        ...
                        foreach ($all_news_category as $news) {
                            ...
                            if($dt[1] == '02') {$month = 'Fev';}
                            if($dt[1] == '03') {$month = 'Mar';}
                            if($dt[1] == '04') {$month = 'Abr';}
                            if($dt[1] == '05') {$month = 'Mai';}
                            if($dt[1] == '06') {$month = 'Jun';}
                            if($dt[1] == '07') {$month = 'Jul';}
                            if($dt[1] == '08') {$month = 'Ago';}
                            if($dt[1] == '09') {$month = 'Set';}
                            if($dt[1] == '10') {$month = 'Out';}
                            if($dt[1] == '11') {$month = 'Nov';}
                            if($dt[1] == '12') {$month = 'Dez';}
                            $year = $dt[2];
                            $day = $dt[0];
                            ?>
                            <div class="blog-item effect-item">
                                ...
                                <div class="blog-text">
                                    ...
                                    <span><i class="fa fa-calendar-o"></i><?php echo $day.' de '.$month.' de '.$year; ?></span>
                                    <p>
...
<!--Brand-Area Start-->
<?php if($page_home['home_client_status'] == 'Mostrar'): ?>
    <div class="brand-area bg-area pt_90 pb_90">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="headline">
                        <h2><?php echo $page_home['home_client_title']; ?></h2>
                        <h3><?php echo $page_home['home_client_subtitle']; ?></h3>
                    </div>
                </div>
            </div>
            <div class="row">
...
<!-- Modal-Aviso-Start -->
<?php if($page_home['home_notice_status'] == 'Mostrar'): ?>
    <div class="modal fade" id="modal_info" tabindex="-1" role="dialog" aria-labelledby="TituloModalCentralizado" aria-hidden="true" style="margin-top: 2%;">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content" style="margin-top: 3%; border-radius: 7px;">
                <div class="modal-header bg-success" style="border-top-left-radius: 7px; border-top-right-radius: 7px;">
                    <h4 class="modal-title text-white" id="TituloModalCentralizado"><i class="fa fa-info-circle"></i> <?php echo $page_home['home_notice_title'] ;?></h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Fechar">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <?php echo $page_home['home_notice_message'] ;?>
                </div>
                <div class="modal-footer bg-success" style="border-bottom-right-radius: 7px; border-bottom-left-radius: 7px;">
