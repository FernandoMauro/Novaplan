                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer-item" id="newsletter">
                        ...
                        <div class="input-group">                            
                            <input type="email" class="form-control" placeholder="<?php echo EMAIL_ADDRESS; ?>" name="email_subscribe" value="<?php echo set_value('email_subscribe'); ?>" required>
	...
	<script type="text/javascript">
		...
		(function(){
			...
			s1.async=true;
			s1.src='https://embed.tawk.to/6001dbfdc31c9117cb6f1074/1es3k6m4d';
			s1.charset='UTF-8';
