			...
			<?php echo form_open_multipart(base_url().'admin/portfolio/edit/'.$portfolio['id'],array('class' => 'form-horizontal')); ?>
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Conteúdo curto *</label>
							<div class="col-sm-8">
						...
						<h3 class="seo-info">Foto em destaque</h3>
						<div class="form-group">
						...
						<h3 class="seo-info">Outras fotos</h3>
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Outras fotos existentes</label>
						...
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Adicionar outras fotos</label>
							<div class="col-sm-6" style="padding-top:5px">
