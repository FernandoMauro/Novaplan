...
<section class="content-header">
	<div class="content-header-left">
		<h1>Editar - Por que nos escolher?</h1>
	</div>
	<div class="content-header-right">
		<a href="<?php echo base_url(); ?>admin/why_choose" class="btn btn-primary btn-sm">Ver todos</a>
	</div>
</section>
				...
				<div class="box box-info">
					<div class="box-body">						
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
                                <select name="icon" class="form-control select" style="font-family: 'FontAwesome', 'Second Font name';" >
                                    <?php
                                    foreach ($why_choose_icons as $row) {
                                    ?>
                                        <option value="<?php echo $row['icons_name']; ?>"<?php if($why_choose['icon'] == $row['icons_name']) {echo 'selected';} ?>><?php echo $row['icons_code']; ?> <?php echo $row['icons_name']; ?>
                                        </option>
                                    <?php
                                    }
                                    ?>
