...
<section class="content-header">
	<div class="content-header-left">
		<h1>Editar Tabela de Preços</h1>
	</div>
	<div class="content-header-right">
		<a href="<?php echo base_url(); ?>admin/pricing_table" class="btn btn-primary btn-sm">Ver todos</a>
	</div>
</section>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
                                <select name="icon" class="form-control select" style="font-family: 'FontAwesome', 'Second Font name';" >
                                    <?php
                                    foreach ($pricing_icons as $row) {
                                    ?>
                                        <option value="<?php echo $row['icons_name']; ?>"<?php if($pricing_table['icon'] == $row['icons_name']) {echo 'selected';} ?>><?php echo $row['icons_code']; ?> <?php echo $row['icons_name']; ?>
                                        </option>
                                    <?php
                                    }
                                    ?>
