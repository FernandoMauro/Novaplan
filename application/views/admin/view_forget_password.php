...
<head>
	...
	<title>Novaplan - Esqueceu a senha</title>
...
<div class="login-box">
	<div class="login-logo">
  	...
  	<div class="login-box-body">
    	...
    	<h4 class="login-box-msg">Esqueceu a senha</h4>
		...
		<?php echo form_open(base_url().'admin/forget-password');?>
			<div class="form-group has-feedback">
				<input class="form-control" placeholder="Email" name="email" type="text" autocomplete="off" autofocus>
			</div>
			<div class="row">
				<div class="col-xs-8" style="padding-top:7px;"><a href="<?php echo base_url(); ?>admin/login" style="color:red;">voltar à página de login</a></div>
				<div class="col-xs-4">
					<input type="submit" class="btn btn-primary btn-block btn-flat login-button" name="form1" value="Enviar">
				</div>
			</div>
		<?php echo form_close(); ?>
	</div>
