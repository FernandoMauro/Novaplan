							...
							foreach ($news as $row) {
								...
								<tr>
									...
									<td>										
										...
										<button type="button" class="btn btn-danger btn-xs" value="<?php echo base_url(); ?>admin/news/delete/<?php echo $row['news_id']; ?>" data-toggle="modal" data-target="#confirm-delete">Excluir</button>
