			                            ...
			                            <div class="modal-content">
			                                ...
			                                <div class="modal-body">
			                                    <div class="rTable">
			                                        ...
			                                        <div class="rTableRow">
			                                            <div class="rTableHead"><strong>Empresa Cliente</strong></div>
			                                            <div class="rTableCell">
			                                                <?php echo $row['client_company']; ?>
			                                            </div>
			                                        </div>
			                                        <div class="rTableRow">
			                                            <div class="rTableHead"><strong>Data de início da Obra</strong></div>
			                                            <div class="rTableCell">
			                                                <?php echo $row['start_date']; ?>
			                                            </div>
			                                        </div>
			                                        <div class="rTableRow">
			                                            <div class="rTableHead"><strong>Data de término da Obra</strong></div>
			                                            <div class="rTableCell">
			                                        ...
			                                        <div class="rTableRow">
			                                            <div class="rTableHead"><strong>Produto Instalado</strong></div>
			                                            <div class="rTableCell">
