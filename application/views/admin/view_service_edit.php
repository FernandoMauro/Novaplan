...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="<?php echo base_url(); ?>admin/service" class="btn btn-primary btn-sm">Ver todos</a>
	</div>
</section>
							...
							<div class="col-sm-6" style="padding-top:5px">
								<table class="table table-bordered">
									...
									foreach ($all_photos_by_id as $row) {
										...
										<tr>
											<td>
												<img src="<?php echo base_url(); ?>public/uploads/service_photos/<?php echo $row['photo']; ?>" alt="" style="width:120px;">
											</td>
											<td>
												<a href="<?php echo base_url(); ?>admin/service/single-photo-delete/<?php echo $row['id']; ?>/<?php echo $service['id']; ?>" class="btn btn-danger btn-xs" onClick="return confirm('Você tem certeza?');">Delete</a>
											</td>
										</tr>
										<?php
									}
