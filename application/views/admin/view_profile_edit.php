...
<section class="content">
	...
	<div class="row">
		<div class="col-md-12">
			...
			<?php echo form_open_multipart(base_url().'admin/profile/edit/'.$profile['id'],array('class' => 'form-horizontal'));?>
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" autocomplete="off" class="form-control" name="email" value="<?php echo $profile['email']; ?>">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<select name="role" class="form-control select2">
									<option value="Admin" <?php if($profile['role']=='Admin'){echo 'selected';} ?>>Administrador</option>
									<option value="Client" <?php if($profile['role']=='Client'){echo 'selected';} ?>>Cliente</option>
								</select>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-2">
								<select name="status" class="form-control select2">
									<option value="Active"  <?php if($profile['status']=='Active'){echo 'selected';} ?>>Ativo</option>
									<option value="Inactive" <?php if($profile['status']=='Inactive'){echo 'selected';} ?>>Inativo</option>
								</select>
							</div>
						</div>
						<div class="form-group">
