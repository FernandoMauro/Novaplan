...
<head>
	...
	<title>Novaplan - Redefinir senha</title>
...
<div class="login-box">
	<div class="login-logo">
  	...
  	<div class="login-box-body">
    	...
    	<h4 class="login-box-msg">Redefinir senha</h4>
		...
		<?php echo form_open(base_url().'admin/reset-password/index/'.$var1.'/'.$var2);?>
			<div class="form-group has-feedback">
				<input class="form-control" placeholder="Nova Senha" name="new_password" type="password" autocomplete="off" autofocus>
			</div>
			<div class="form-group has-feedback">
				<input class="form-control" placeholder="Repita a Senha" name="re_password" type="password" autocomplete="off" autofocus>
			</div>
			<div class="row">
