						...
						<div class="form-group">
							...
							<div class="col-sm-8">
                                <select name="icon" class="form-control select" style="font-family: 'FontAwesome', 'Second Font name';" >
                                    <?php
                                    foreach ($feature_icons as $row) {
                                    ?>
                                        <option value="<?php echo $row['icons_name']; ?>"<?php if($feature['icon'] == $row['icons_name']) {echo 'selected';} ?>><?php echo $row['icons_code']; ?> <?php echo $row['icons_name']; ?>
                                        </option>
                                    <?php
                                    }
                                    ?>
